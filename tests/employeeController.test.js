...
describe('EmployeeController', () => {
  ...
  describe('createEmployee', () => {
    it('should create an employee and return the result', async () => {
      ...
      expect(res.json).toHaveBeenCalledWith({ status: 201, message: 'Employee created' });
    });
    ...
    it('should handle errors', async () => {
      ...
      expect(res.json).toHaveBeenCalledWith({ errorMessage: 'Error creating employee' });
    });
  });
  ...
  describe('getAllEmployees', () => {
    ...
    it('should handle errors', async () => {
      ...
      expect(res.status).toHaveBeenCalledWith(500);
      expect(res.json).toHaveBeenCalledWith({ errorMessage: 'Error retrieving employees' });
    });
  });
  ...
  describe('getEmployeeById', () => {
    it('should return an employee by ID', async () => {
      req.params = { id: '1' };
      EmployeeService.getEmployeeById.mockResolvedValue({ status: 200, message: 'Employee found' });
    ...
    it('should handle errors', async () => {
      req.params = { id: '1' };
      EmployeeService.getEmployeeById.mockRejectedValue(new Error('Error retrieving employee'));

      await EmployeeController.getEmployeeById(req, res);

      expect(res.status).toHaveBeenCalledWith(500);
      expect(res.json).toHaveBeenCalledWith({ errorMessage: 'Error retrieving employee' });
    });
  });
  ...
  describe('updateEmployee', () => {
    ...
    it('should handle errors', async () => {
      ...
      expect(res.status).toHaveBeenCalledWith(500);
      expect(res.json).toHaveBeenCalledWith({ errorMessage: 'Error updating employee' });
    });
  });
  ...
  describe('deleteEmployee', () => {
    it('should delete an employee and return the result', async () => {
      req.params = { id: '1' };
      EmployeeService.deleteEmployee.mockResolvedValue({ status: 200, message: 'Employee deleted' });

      await EmployeeController.deleteEmployee(req, res);

      expect(EmployeeService.deleteEmployee).toHaveBeenCalledWith(1);
      expect(res.status).toHaveBeenCalledWith(200);
      expect(res.json).toHaveBeenCalledWith({ status: 200, message: 'Employee deleted' });
    });

    it('should handle errors', async () => {
      req.params = { id: '1' };
      EmployeeService.deleteEmployee.mockRejectedValue(new Error('Error deleting employee'));

      await EmployeeController.deleteEmployee(req, res);

      expect(res.status).toHaveBeenCalledWith(500);
      expect(res.json).toHaveBeenCalledWith({ errorMessage: 'Error deleting employee' });
    });
  });
});
